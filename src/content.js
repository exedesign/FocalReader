  ...
  function injectStyles(){
    ...
    try {
      ...
      style.textContent = `
        ...
        #spritz-progress-container{position:fixed;bottom:100px;left:50%;transform:translateX(-50%);width:500px;text-align:center;z-index:999999;pointer-events:auto;}
        #spritz-progress-bar{width:100%;height:4px;background:#2a2a2a;border-radius:2px;cursor:pointer;position:relative;overflow:hidden;margin-bottom:6px;pointer-events:auto;}
