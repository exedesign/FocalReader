  ...
  function injectStyles(){
    ...
    try {
      ...
      style.textContent = `
        ...
        #spritz-progress-container{position:fixed;bottom:80px;left:50%;transform:translateX(-50%);width:450px;text-align:center;z-index:999999;pointer-events:auto;}
        ...
        .pdf-page-marker{position:absolute;top:0;width:1px;height:100%;background:#555;opacity:0.5;pointer-events:none;z-index:1;}
        .pdf-page-number{position:absolute;top:-18px;transform:translateX(-50%);font-size:9px;color:#888;font-weight:400;pointer-events:none;white-space:nowrap;display:none;}
